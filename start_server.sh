#!/bin/bash
# start_server.sh - Arranca MySQL y MusicCloud Server

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
LOG_FILE="/tmp/musiccloud_server.log"
PID_FILE="/tmp/musiccloud_server.pid"

echo "🎵 Iniciando MusicCloud..."
...
# Liberar puerto 5000 por si acaso
